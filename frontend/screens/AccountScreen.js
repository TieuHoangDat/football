...
import { View, Text, StyleSheet, TouchableOpacity, Alert, ScrollView, Switch, ActivityIndicator, Animated, LayoutAnimation, Platform, UIManager } from "react-native";
    ...
    try {
      ...
      Object.keys(response.data).forEach(key => {
        ...
        if (key === 'id' || key === 'user_id' || 
            key === 'created_at' || key === 'quiet_hours_start' || 
            key === 'quiet_hours_end') {
      ...
      await AsyncStorage.setItem('notificationSettings', JSON.stringify(convertedSettings));
      setLoading(false);
    } catch (error) {
      ...
      setLoading(false);
      Alert.alert("Lỗi", "Không thể tải cài đặt thông báo. Vui lòng thử lại sau.");
    }
  };
  ...
  const SettingItem = ({ title, field, value, icon }) => (
    <View style={styles.settingItem}>
      <View style={styles.settingInfo}>
        <Ionicons name={icon} size={22} color={value ? COLORS.primary : COLORS.textSecondary} style={styles.settingIcon} />
        <Text style={[styles.settingText, value && styles.settingTextActive]}>{title}</Text>
      </View>
      <Switch
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollViewContent}>
        <View style={styles.section}>
          ...
          {/* Thông tin tài khoản sẽ được thêm ở đây */}
            ...
            <View style={styles.settingsContainer}>
              ...
              >
                ...
                <SettingItem 
                  ...
                  value={notificationSettings.fixture_reminders}
              ...
              >
                ...
                <SettingItem 
                  ...
                  value={notificationSettings.competition_updates}
                  icon="trophy-outline"
                />
                <SettingItem 
